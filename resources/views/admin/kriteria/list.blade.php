                ...
                <table class="table table-striped">
                  ...
                  @foreach ($getRecord as $value)
                    <tr>
                      ...
                      <td>
                        <a href="{{ url('admin/kriteria/edit-kriteria/' .$value->id) }}" class="btn btn-warning">Edit</a>
                        <a href="{{ url('admin/kriteria/delete-kriteria/' .$value->id) }}" class="btn btn-danger">Delete</a>
                      </td>
                    </tr>
                  @endforeach
                  </tbody>
