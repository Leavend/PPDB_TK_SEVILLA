                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($getRecord as $value)
                                            <tr>
                                                ...
                                                <td>{{ $value->bobot }}</td>
                                                <td>
                                                    <a href="{{ url('admin/kriteria/show-crips/' . $value->id) }}"
                                                        class="btn btn-circle btn-info"><i class="fas fa-eye"></i></a>
                                                    <a href="{{ url('admin/kriteria/edit-kriteria/' . $value->id) }}"
                                                        class="btn btn-circle btn-warning"><i class="fas fa-edit"></i></a>
                                                    <a href="{{ url('admin/kriteria/delete-kriteria/' . $value->id) }}"
