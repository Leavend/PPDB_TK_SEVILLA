                            ...
                            <td>
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <span class="badge badge-success">Terverifikasi<span class="ms-1 fa fa-check"></span></span>
                                        @elseif($x->status_pendaftaran == 'Belum Terverifikasi')
                                        <span class="badge badge-warning">Belum <br> Terverifikasi<br><span class="ms-1 fas fa-stream"></span></span>
                                        @elseif($x->status_pendaftaran == 'Selesai')
                                        <span class="badge badge-primary">Selesai<span class="ms-1 fa fa-check"></span></span>
                                        @else
                                        <span class="badge badge-danger">Not Found<span class="ms-1 fa fa-ban"></span></span>
                                        @endif
                                    </div>
                                    <div class="col-md-6">
                                        <div class="dropdown text-sans-serif">
                                            <button class="btn btn-primary tp-btn-light sharp" type="button" id="order-dropdown-7"
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end border py-0"
                                                ...
                                                <div class="py-2">
                                                    <a class="dropdown-item" href="/verified-registration/{{ $x->id_pendaftaran }}">Terverifikasi</a>
                                                    <a class="dropdown-item"
                                                        href="/notverified-registration/{{ $x->id_pendaftaran }}">Belum Terverifikasi</a>
                                                    <div class="dropdown-divider"></div>
                                                    <a class="dropdown-item text-success"
                                                        href="/finish-registration/{{ $x->id_pendaftaran }}">Selesai</a>
                                                    <div class="dropdown-divider"></div>
                                                    <a class="dropdown-item text-danger"
                                                        href="/invalid-registration/{{ $x->id_pendaftaran }}">Tidak Sah</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <td>
                                <div class="d-flex">
                                    <a class="btn btn-secondary shadow btn-xs sharp me-1" title="Detail Registration"
                                        href="detail-registration/{{ $x->id_pendaftaran }}"><i class="fa fa-file-alt"></i></a>
                                    <a class="btn btn-primary shadow btn-xs sharp me-1" title="Edit"
                                        href="edit-registration/{{ $x->id_pendaftaran }}"><i class="fa fa-pencil-alt"></i></a>
                                    <a class="btn btn-danger shadow btn-xs sharp" data-bs-toggle="modal"
                                        data-bs-target=".delete{{ $x->id_pendaftaran }}"><i class="fa fa-trash"></i></a>
                                        ...
                                        <div class="modal-dialog modal-sm">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body text-center">
                                                    <i class="fa fa-trash"></i><br> Anda yakin ingin menghapus data ini?<br>
                                                    {{ $x->id_pendaftaran }}
                                                </div>
      ...
      <div class="project-page d-flex justify-content-between align-items-center flex-wrap">
          <div class="project mb-4">
              <ul class="nav nav-tabs" role="tablist">
                  ...
                  <li class="nav-item">
                      <a class="nav-link" data-bs-toggle="tab" href="#Finish" role="tab">Selesai/Lihat Pengumuman</a>
                  </li>
                  <li class="nav-item">
          ...
          <div class="mb-4">
            ...
            @if ($no == 0)
                <a href="/siswa/formulir-pendaftaran" class="btn btn-primary btn-rounded fs-18">+ Daftar Seleksi</a>
            @endif
          </div>
      </div>
                ...
                <div class="card-body">
                  <div class="row align-items-center">
                    <div class="col-xl-4  col-lg-6 col-sm-12 align-items-center customers">
                      <span class="text-primary d-block fs-18 font-w500 mb-1" style="margin-top: -1.5rem"><strong>{{ $x->id_pendaftaran }}</strong></span>
                      <span class="d-block mb-lg-0 mb-0 fs-16"><i class="fas fa-calendar me-3"></i>Didaftarkan tanggal{{ $x->tgl_pendaftaran }}</span>
                    </div>
                    <div class="col-xl-3 col-lg-3 col-sm-4 col-6 mb-3">
                      <div class="d-flex project-image">
                          <img src="{{ url('/' . $x->pas_foto) }}" alt="">
                          <div>
                              <small class="d-block fs-16 font-w400" style="margin-top: -1rem">Pendaftar</small>
                    ...
                    <div class="col-xl-3 col-lg-6 col-sm-6 mb-sm-4 mb-0">
                      <div class="d-flex project-image">
                          ...
                          <div>
                              <small class="d-block fs-16 font-w400">{{ $x->pilihan1->nama_prodi }}</small>
                    ...
                    <div class="col-xl-2 col-lg-6 col-sm-4 mb-sm-3 mb-3 text-end">
                        <div class="d-flex justify-content-end project-btn">
                            @if ($x->status_pendaftaran == 'Belum Terverifikasi')
                                <a href="detail-registration/{{ $x->id_pendaftaran }}" class="btn bgl-warning text-warning fs-16 font-w600">Belum<br>Terverifikasi</a>
                            @elseif ($x->status_pendaftaran == 'Terverifikasi')
                                <a href="detail-registration/{{ $x->id_pendaftaran }}" class="btn bgl-warning text-success fs-16 font-w600">Terverifikasi</a>
                            @elseif ($x->status_pendaftaran == 'Selesai')
                                <a href="detail-registration/{{ $x->id_pendaftaran }}" class="btn bgl-warning text-success fs-16 font-w600">Selesai</a>
                            @else
                                <a href="detail-registration/{{ $x->id_pendaftaran }}" class="btn bgl-warning text-danger fs-16 font-w600">Tidak Sah</a>
                            @endif
                            <div class="dropdown ms-4 mt-auto mb-auto">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a class="dropdown-item" href="detail-registration/{{ $x->id_pendaftaran }}">Lihat Selengkapnya</a>
                                    @if ($x->status_pendaftaran == 'Selesai')
                                        <a class="dropdown-item" href="view-announcement/{{ $x->id_pendaftaran }}">Lihat Pengumuman</a>
                                    @endif
                                </div>
                            </div>
                        </div>
                ...
                @if ($x->status_pendaftaran == 'Belum Terverifikasi' || $x->status_pendaftaran == 'Terverifikasi')
                    <div class="card">
                        <div class="card-body">
                            <div class="row align-items-center">
                                <div class="col-xl-4 col-lg-6 col-sm-12 align-items-center customers">
                                    <span class="text-primary d-block fs-18 font-w500 mb-1" style="margin-top: -1.5rem">{{ $x->id_pendaftaran }}</span>
                                    <span class="d-block mb-lg-0 mb-0 fs-16"><i class="fas fa-calendar me-3"></i>Didaftarkan tanggal {{ $x->tgl_pendaftaran }}</span>
                                </div>
                                <div class="col-xl-3 col-lg-3 col-sm-4 col-6 mb-3">
                                    <div class="d-flex project-image">
                                ...
                                <div class="col-xl-2 col-lg-6 col-sm-4 mb-sm-3 mb-3 text-end">
                                    <div class="d-flex justify-content-end project-btn">
                                        ...
                                        <div class="dropdown ms-4 mt-auto mb-auto">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a class="dropdown-item" href="detail-registration/{{ $x->id_pendaftaran }}">Lihat Selengkapnya</a>
                                                <a class="dropdown-item" href="view-announcement/{{ $x->id_pendaftaran }}">Lihat Hasil Seleksi</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
