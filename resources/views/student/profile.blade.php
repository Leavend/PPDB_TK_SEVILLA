            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <ul class="list-group list-group-unbordered mb-3">
                  ...
                  <li class="list-group-item">
                    <b>No HP Wali :</b> <a class="float-right">{{ Auth::user()->profile->no_hp ? Auth::user()->profile->no_hp : "-" }}</a>
                  </li>
                  <li class="list-group-item">
            ...
            <div class="card">
              <div class="card-header p-2">
                <ul class="nav nav-pills">
                  <li class="nav-item"><a class="nav-link active" href="#profileuser" data-toggle="tab">Profile Siswa</a></li>
                  <li class="nav-item"><a class="nav-link" href="#settings" data-toggle="tab">Pengaturan Profile</a></li>
                </ul>
              </div>
              <!-- /.card-header -->
              ...
              <div class="card-body">
                <div class="tab-content">
                  <div class="active tab-pane" id="profileuser">
                    @if (Auth::user()->profile->no_hp == null || Auth::user()->profile->tempat_lahir == null || Auth::user()->profile->jenis_kelamin == null)
                    <br>
                      <div class="alert alert-warning alert-dismissible fade show">
                        ...
                        <strong>Peringatan!</strong> Data belum lengkap. Silahkan lengkapi data akun sekarang di <b>Pengaturan Profile</b>.
                    ...
                    <div class="card-body">
                      ...
                      <p class="text-muted">{{ Auth::user()->profile->tempat_lahir ? Auth::user()->profile->tempat_lahir : "-" }}</p>
                      <hr>
                  ...
                  <div class="tab-pane" id="settings">
                    <form class="form-horizontal" method="post" action="{{ route('update-user', Auth::user()->profile->user_id) }}" enctype="multipart/form-data">
                    @csrf
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="text" disabled="disabled" style="width: 100%;" class="form-control" id="inputName" placeholder="Name" name="nama" value="{{ Auth::user()->profile->nama }}">
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="email" disabled="disabled" style="width: 100%;" class="form-control" id="inputEmail" placeholder="Email" name="email" value="{{ Auth::user()->profile->email }}">
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <select class="form-control wide" style="width: 100%;" required name="jenis_kelamin">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="date" class="form-control" id="inputTanggalLahir" name="tanggal_lahir" required value="{{ old('tanggal_lahir') }}">
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="inputNoHP" name="no_hp" placeholder="Nomor HP" value="{{ old('no_hp') }}">
                        </div>
                      </div>
